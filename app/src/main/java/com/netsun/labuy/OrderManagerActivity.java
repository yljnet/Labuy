...
public class OrderManagerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        totalOrderFragment = new OrderManagerFragment("全部",ORDER_ALL);
        titles.add(totalOrderFragment.getTitle());
        unPayOrderFragment = new OrderManagerFragment("未支付",ORDER_UNPAY);
        titles.add(unPayOrderFragment.getTitle());
        payedOrderFragment = new OrderManagerFragment("已支付",ORDER_PAYED);
        titles.add(payedOrderFragment.getTitle());
